...
namespace Nop.Services.Catalog
{
    ...
    {
        /// <summary>
        /// Get (visible) product number in certain collection
        /// </summary>
        /// <param name="collectionIds">Collection identifiers</param>
        /// <param name="storeId">Store identifier; 0 to load all records</param>
        /// <returns>Product number</returns>
        public virtual int GetCollectionProductNumber(IList<int> collectionIds = null, int storeId = 0)
        {
        ...
        /// <summary>
        /// Get (visible) product number in certain attraction
        /// </summary>
        /// <param name="attractionIds">Attraction identifiers</param>
        /// <param name="storeId">Store identifier; 0 to load all records</param>
        /// <returns>Product number</returns>
        public virtual int GetAttractionProductNumber(IList<int> attractionIds = null, int storeId = 0)
        {
        ...
        public virtual IPagedList<Product> DvSearchProducts(
