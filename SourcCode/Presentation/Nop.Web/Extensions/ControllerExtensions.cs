...
namespace Nop.Web.Extensions
{
    ...
    public static class ControllerExtensions
    {
            ...
            return cacheManager.Get(cacheKey, () =>
                ...
                .Select(psa =>
                {
                    var m = new ProductSpecificationModel
                    {
                        ...
                        SystemName = psa.SpecificationAttributeOption.SpecificationAttribute.SystemName,
                        CssClass = psa.SpecificationAttributeOption.SpecificationAttribute.CssClass
                    };
        ...
        public static IList<CategorySpecificationModel> PrepareCategorySpecificationModel(this Controller controller,
            IWorkContext workContext,
            ISpecificationAttributeService specificationAttributeService,
            ICacheManager cacheManager,
            Category category)
        {
            ...
            string cacheKey = string.Format(ModelCacheEventConsumer.CATEGORY_SPECS_MODEL_KEY, category.Id, workContext.WorkingLanguage.Id);
            return cacheManager.Get(cacheKey, () =>
                specificationAttributeService.GetCategorySpecificationAttributes(category.Id, 0, null, true)
                .Select(psa =>
                {
                    var m = new CategorySpecificationModel
                    {
                        SpecificationAttributeId = psa.SpecificationAttributeOption.SpecificationAttributeId,
                        SpecificationAttributeName = psa.SpecificationAttributeOption.SpecificationAttribute.GetLocalized(x => x.Name),
                        SystemName = psa.SpecificationAttributeOption.SpecificationAttribute.SystemName,
