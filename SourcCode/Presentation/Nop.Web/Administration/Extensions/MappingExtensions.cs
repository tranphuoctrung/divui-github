...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        #region DvGroupProduct

        public static ProductModel.ProductOptionModel ToModel(this ProductOption entity)
        {
            return entity.MapTo<ProductOption, ProductModel.ProductOptionModel>();
        }

        public static ProductOption ToEntity(this ProductModel.ProductOptionModel model)
        {
            return model.MapTo<ProductModel.ProductOptionModel, ProductOption>();
        }

        public static ProductOption ToEntity(this ProductModel.ProductOptionModel model, ProductOption destination)
        {
            return model.MapTo(destination);
        }
