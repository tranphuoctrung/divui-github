            ...
            if (data != null && DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                switch (urlRecord.EntityName.ToLowerInvariant())
                {
                    ...
                    case "collection":
                        {
                            data.Values["controller"] = "Catalog";
                            data.Values["action"] = "Collection";
                            data.Values["collectionid"] = urlRecord.EntityId;
                            data.Values["SeName"] = urlRecord.Slug;
                        }
                        break;
                    ...
                    case "attraction":
                        {
                            data.Values["controller"] = "Catalog";
                            data.Values["action"] = "Attraction";
                            data.Values["attractionid"] = urlRecord.EntityId;
                            data.Values["SeName"] = urlRecord.Slug;
                        }
                        break;
                    ...
                    case "dvgroupproduct":
                        {
                            ...
                            data.Values["action"] = "ProductDetails";
                            data.Values["productid"] = urlRecord.EntityId;
                            data.Values["groupproductid"] = urlRecord.EntityId;
                            data.Values["SeName"] = urlRecord.Slug;
                        }
                        break;
