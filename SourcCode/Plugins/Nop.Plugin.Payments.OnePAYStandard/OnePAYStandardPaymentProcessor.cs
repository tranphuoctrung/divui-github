...
using Nop.Plugin.Payments.OnePAYStandard.Controllers;
...
namespace Nop.Plugin.Payments.OnePAYStandard
{
    ...
    /// </summary>
    public class OnePAYStandardPaymentProcessor : BasePlugin, IPaymentMethod
    {
        #region Fields

        private readonly OnePAYStandardPaymentSettings _onePAYPaymentSettings;
        ...
        public OnePAYStandardPaymentProcessor(OnePAYStandardPaymentSettings onePAYPaymentSettings,
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "PaymentOnePAYStandard";
            routeValues = new RouteValueDictionary() { { "Namespaces", "Nop.Plugin.Payments.OnePAYStandard.Controllers" }, { "area", null } };
        }
        ...
        {
            return typeof(PaymentOnePAYStandardController);
        }
        ...
        {
            //settings
            var settings = new OnePAYStandardPaymentSettings()
            {
            ...
            //locales
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.RedirectionTip", "Hệ thống sẽ tự động chuyển sang cổng thanh toán OnePAY sau khi bạn xác nhận đơn hàng.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.UseSandbox", "Sử dụng cổng test");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.UseSandbox.Hint", "Chọn Sandbox nếu bạn muốn giao dịch trên cổng thử nghiệm.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.MerchantID", "MerchantID");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.MerchantID.Hint", "Nhập mã MerchantID do OnePAY cung cấp.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AccessCode", "AccessCode");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AccessCode.Hint", "Nhập mã AccessCode do OnePAY cung cấp.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.HashCode", "HashCode");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.HashCode.Hint", "Nhập mã HashCode do OnePAY cung cấp.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AdditionalFee", "Phí dịch vụ");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AdditionalFee.Hint", "Chọn mức phí khi sử dụng dịch vụ.");
        ...
        {
            //settings
            _settingService.DeleteSetting<OnePAYStandardPaymentSettings>();

            //locales
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.RedirectionTip");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.UseSandbox");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.UseSandbox.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.MerchantID");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.MerchantID.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AccessCode");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AccessCode.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.HashCode");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.HashCode.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AdditionalFee");
            this.DeletePluginLocaleResource("Plugins.Payments.OnePAYStandard.Fields.AdditionalFee.Hint");
