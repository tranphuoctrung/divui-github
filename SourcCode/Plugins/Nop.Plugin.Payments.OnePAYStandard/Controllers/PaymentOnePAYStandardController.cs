...
using Nop.Plugin.Payments.OnePAYStandard.Models;
...
namespace Nop.Plugin.Payments.OnePAYStandard.Controllers
{
    public class PaymentOnePAYStandardController : BasePaymentController
    {
        ...
        public PaymentOnePAYStandardController(ISettingService settingService,
            IPaymentService paymentService, IOrderService orderService,
            IOrderProcessingService orderProcessingService,
            ILogger logger, IWebHelper webHelper,
            OnePAYStandardPaymentSettings onePAYPaymentSettings,
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Payments.OnePAYStandard/Views/PaymentOnePAYStandard/Configure.cshtml", model);
        }
        ...
        {
            return View("~/Plugins/Payments.OnePAYStandard/Views/PaymentOnePAYStandard/PaymentInfo.cshtml");
        }
        ...
        public ActionResult PDTHandler(FormCollection form)
        {
            ...
            var processor = _paymentService.LoadPaymentMethodBySystemName("Payments.OnePAYStandard") as OnePAYStandardPaymentProcessor;
            if (processor == null ||
